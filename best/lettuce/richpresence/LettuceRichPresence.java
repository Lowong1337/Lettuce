...
public class LettuceRichPresence {
    ...
    public static void startrpc() {
        ...
        DiscordRPC.discordInitialize("1007119129377001512", handlers, true);
        ...
        b.setBigImage("lettucebig", "Lettuce Client " + MinecraftInstance.VERSION);
        b.setSmallImage("info", "lettuce.gay");
