...
public class AutoHypixel extends Module {
    ...
    public final EventListener<EventRender2D> onrender2d = e -> {
        ...
        switch (hud.colorMode.getMode()){
            case "Rainbow" -> c = ColorUtils.rainbow(hud.colorSpeed.getValue().intValue(), 0, hud.saturation.getValue().floatValue(), 1, 1);
            case "Double Colors" -> c = ColorUtils.interpolateColorsBackAndForth(15, 0, hud.color1.getColor(), hud.color2.getColor(), false);
            case "Fade" -> c = ColorUtils.interpolateColorsBackAndForth(15, 0, hud.color1.getColor(), hud.color1.getColor().darker().darker(), false);
            case "Static" -> c = ColorUtils.interpolateColorsBackAndForth(15, 0, hud.color1.getColor(), hud.color1.getColor(), false);
        }
