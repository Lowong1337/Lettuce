...
public class Speed extends Module {
    ...
    public final EventListener<EventPacketSend> onPacketSend = e -> {
        ...
        if (mode.is("Vulcan Exploit") && packet instanceof C09PacketHeldItemChange) {
            currentSlot = ((C09PacketHeldItemChange) packet).getSlotId();
            e.cancel();
        }
    };
                ...
                if (MoveUtils.isMoving()) {
                    if (mc.thePlayer.isCollidedHorizontally && mc.thePlayer.onGround) {
                        ...
                        switch (mc.thePlayer.offGroundTicks) {
                            ...
                            case 1: mc.thePlayer.motionY = MoveUtils.HEAD_HITTER_MOTION; break;
                        }
                    }
                }
                break;
            ...
            case "Vulcan Exploit": {
                if (MoveUtils.isMoving() && blockSlot > -1) {
                    ...
                    switch (mc.thePlayer.offGroundTicks) {
                        case 0: {
                            switch (speed) {
                                case 0: MoveUtils.strafe(0.55f); break;
                                case 1: MoveUtils.strafe(0.65f - 0.11f); break;
                                default: MoveUtils.strafe(0.85f - 0.18f); break;
                            }
                        ...
                        case 1: {
                            ...
                            switch (speed) {
                                case 0: MoveUtils.strafe(0.45f - 0.02f); break;
                                case 1: MoveUtils.strafe(0.6f - 0.11f); break;
                                default: MoveUtils.strafe(0.75f - 0.18f); break;
                            }
                            break;
                        }
                        case 2: {
                            switch (speed) {
                                case 0: MoveUtils.strafe(0.4f - 0.03f); break;
                                case 1: MoveUtils.strafe(0.55f - 0.11f); break;
                                default: MoveUtils.strafe(0.65f - 0.18f); break;
                            }
                            break;
                        }
                    }
