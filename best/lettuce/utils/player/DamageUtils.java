...
public class DamageUtils implements MinecraftInstance {
    ...
    public static void bowDamage(EventMotion e, int tick) {
        ...
        switch (tick) {
            case 1: PacketUtils.sendPacketNoEvent(new C09PacketHeldItemChange(bowSlot)); break;
            case 3: PacketUtils.sendPacketNoEvent(new C08PacketPlayerBlockPlacement(InventoryUtils.getStackInSlot(bowSlot + 36))); break;
            case 6: PacketUtils.sendPacketNoEvent(new C07PacketPlayerDigging(C07PacketPlayerDigging.Action.RELEASE_USE_ITEM, BlockPos.ORIGIN, EnumFacing.DOWN)); break;
            case 10: PacketUtils.sendPacketNoEvent(new C09PacketHeldItemChange(currentSlot)); break;
        }
    }
