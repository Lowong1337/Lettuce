...
import best.lettuce.utils.misc.FileUtils;
...
public class ShaderUtils implements MinecraftInstance {
    ...
    public ShaderUtils(String fragmentShadersrc, boolean notUsed) {
        ...
        try {
            vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("Lecture/Shaders/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
    ...
    public ShaderUtils(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "Lecture/Shaders/vertex.vsh");
    }
