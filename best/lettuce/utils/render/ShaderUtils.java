...
public class ShaderUtils implements MinecraftInstance {
    ...
    public ShaderUtils(String fragmentShadersrc, boolean notUsed) {
        ...
        try {
            vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation(NAME + "/Shaders/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
    ...
    public ShaderUtils(String fragmentShaderLoc) {
        this(fragmentShaderLoc, NAME + "/Shaders/vertex.vsh");
    }
