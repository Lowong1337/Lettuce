package best.lettuce.utils.non_utils.microsoft;
...
public class MicrosoftLogin {
    ...
    private static final String CLIENT_ID = "402dafb3-5502-4c7b-accc-60bc88927581", CLIENT_SECRET = "xI78Q~TDE5PFlopKCjdhBwUxL1TbU.jbHTJ0Ga51";
    ...
    public static LoginData login(String refreshToken) {
        ...
        AuthTokenResponse res = gson.fromJson(
                Browser.postExternal("https://login.live.com/oauth20_token.srf", "client_id=" + CLIENT_ID + "&client_secret=" + CLIENT_SECRET + "&refresh_token=" + refreshToken + "&grant_type=refresh_token&redirect_uri=https://login.live.com/oauth20_token.srf", false),
