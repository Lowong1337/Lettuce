...
public class DropdownClickGUI extends GuiScreen implements MinecraftInstance {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        RenderUtils.drawImage(new ResourceLocation("Lecture/solatinoclickgui.png"), 0, 0, MinecraftInstance.mc.displayWidth / 2.f, MinecraftInstance.mc.displayHeight / 2.f);
