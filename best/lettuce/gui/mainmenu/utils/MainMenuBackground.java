package best.lettuce.gui.mainmenu.utils;
...
public class MainMenuBackground {
    ...
    public MainMenuBackground(String fragmentShaderLocation) throws IOException {
        ...
        glAttachShader(program, createShader(MainMenuBackground.class.getResourceAsStream("/assets/minecraft/Lecture/Shaders/passthrough.vsh"), GL_VERTEX_SHADER));
        glAttachShader(program, createShader(MainMenuBackground.class.getResourceAsStream(fragmentShaderLocation), GL_FRAGMENT_SHADER));
    ...
    public void useShader(int width, int height, float time) {
        ...
        glUniform2f(this.mouseUniform, width, 1.0f - height);
