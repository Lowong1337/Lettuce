...
public class MenuButton implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        RoundedUtils.drawRoundOutline(x, y, width, height, 12, 1, rectColor, new Color(30, 30, 30, 100));

        lettuceFont22.drawCenteredString(text, x + width / 2f, y + lettuceFont22.getMiddleOfBox(height), -1);
    }
