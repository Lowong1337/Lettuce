...
public class SinglePlayerButton extends GuiButton {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        ...
        if (this.visible)
        {
            ...
            float stringwidth = (float) Lecture.lettuceFont24.getStringWidth(displayString);
            ...
            Lecture.lettuceFont24.drawStringWithShadow(displayString, xPosition - stringwidth + 10, yPosition - ((float) width) - 20, color);
        }
