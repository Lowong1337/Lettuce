...
public class AltPanel extends Panel {
    ...
    public void keyTyped(char typedChar, int keyCode) {
        if (Lecture.INSTANCE.getAltManager().isTyping()) return;
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        TextField searchField = Lecture.INSTANCE.getAltManager().searchField;
        boolean filterBanned = Lecture.INSTANCE.getAltManager().filterBanned.isEnabled();
    ...
    public static class AltRect implements Screen {
        ...
        public void drawScreen(int mouseX, int mouseY) {
            ...
            switch (alt.getType()) {
                case "Microsoft":
                    RenderUtils.drawMicrosoftLogo(typeX + 2, usernameY - 1, size, 1, 1 - credsAnim);
                    break;
                case "Cracked": {
            ...
            if (Lecture.INSTANCE.getAltManager().currentSessionAlt == alt) {
        ...
        public void drawAltHead(float x, float y, float size) {
            Lecture.INSTANCE.getAltManager().getUtils().getHead(alt);
            GLUtils.startBlend();
            RenderUtils.setAlphaLimit(0);
            mc.getTextureManager().bindTexture(alt.head != null ? alt.head : new ResourceLocation("Lecture/X-Steve.png"));
