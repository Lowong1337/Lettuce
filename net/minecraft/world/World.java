...
public abstract class World implements IBlockAccess
{
                    ...
                    if ((!flag2 || !flag3) && this.isBlockLoaded(blockpos$pooledmutableblockpos.setPos(k1, 64, l1)))
                    {
                        for (int i2 = k; i2 < l; ++i2)
                        {
                            if (!flag2 && !flag3 || i2 != l - 1)
                            {
                                ...
                                iblockstate1.getBlock().addCollisionBoxesToList(this, blockpos$pooledmutableblockpos, iblockstate1, p_191504_2_, p_191504_4_, p_191504_1_);

                                if (p_191504_3_) {
                                    assert p_191504_4_ != null;
    ...
    public List<AxisAlignedBB> getCollisionBoxes(Entity entityIn, AxisAlignedBB aabb)
    {
        ...
        if (entityIn != null)
        {
            List<Entity> list1 = this.getEntitiesWithinAABBExcludingEntity(entityIn, aabb.expand(0.25D, 0.25D, 0.25D));
