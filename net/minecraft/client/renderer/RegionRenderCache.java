...
public class RegionRenderCache extends ChunkCache
{
    ...
    private static int maxCacheSize = OFConfig.limit(Runtime.getRuntime().availableProcessors(), 1, 32);
    ...
    public int getCombinedLight(BlockPos pos, int lightValue)
    {
        ...
        if (j == -1)
        {
            ...
            if (OFConfig.isDynamicLights() && !this.getBlockState(pos).getBlock().isOpaqueCube())
            {
