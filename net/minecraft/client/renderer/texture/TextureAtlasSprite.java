...
public class TextureAtlasSprite
{
    ...
    public void copyFrom(TextureAtlasSprite atlasSpirit)
    {
        ...
        if (atlasSpirit != OFConfig.getTextureMap().getMissingSprite())
        {
    ...
    private void loadShadersSprites()
    {
        if (Shaders.configNormalMap)
        {
            ...
            resourcelocation = OFConfig.getTextureMap().completeResourceLocation(resourcelocation);
        ...
        if (Shaders.configSpecularMap)
        {
            ...
            resourcelocation1 = OFConfig.getTextureMap().completeResourceLocation(resourcelocation1);
