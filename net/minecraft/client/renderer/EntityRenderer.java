...
public class EntityRenderer implements IResourceManagerReloadListener {
                ...
                if (flag1 && this.mc.gameSettings.thirdPersonView == 0 && !flag && !this.mc.gameSettings.hideGUI && !this.mc.playerController.isSpectator()) {
                    ...
                    if (OFConfig.isShaders()) {
                        if (mc.thePlayer.getHeldItem() != null) {
                            KillAura aura = Lettuce.INSTANCE.getModuleManager().getModule(KillAura.class);
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        Lettuce.INSTANCE.getEventManager().dispatch(new EventRender3D(partialTicks));
    ...
    private void updateFogColor(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPotionActive(Potion.blindness)) {
            if (Lettuce.INSTANCE.getModuleManager().getModule(Camera.class).isEnabled() && Lettuce.INSTANCE.getModuleManager().getModule(Camera.class).options.isEnabled("Remove Blindness Effect"))
                return;
