...
import best.lettuce.modules.impl.render.ItemPhysics;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    {
        ItemPhysics ip = Lettuce.INSTANCE.getModuleManager().getModule(ItemPhysics.class);
        if(!ip.isEnabled()){
            renderVanilla(entity, x, y, z, entityYaw, partialTicks);
        }
        else {
    ...
    private void physicsRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
        rotation = Lettuce.INSTANCE.getModuleManager().getModule(ItemPhysics.class).speed.getValue().floatValue();
    ...
    public void renderVanilla(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
