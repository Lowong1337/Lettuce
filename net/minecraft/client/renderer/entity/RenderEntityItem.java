...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    {
        ItemPhysics ip = Lecture.INSTANCE.getModuleManager().getModule(ItemPhysics.class);
        if(!ip.isEnabled()){
    ...
    private void physicsRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
        rotation = Lecture.INSTANCE.getModuleManager().getModule(ItemPhysics.class).speed.getValue().floatValue();
