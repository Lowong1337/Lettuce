...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void renderModel(IBakedModel model, int color, ItemStack stack)
    {
        ...
        boolean flag1 = OFConfig.isMultiTexture() && flag;
    ...
    public void renderItem(ItemStack stack, IBakedModel model)
    {
        if (stack != null)
        {
            ...
            else
            {
                ...
                if (stack.hasEffect() && (!OFConfig.isCustomItems() || !CustomItems.renderCustomEffect(this, stack, model)))
                {
    ...
    {
        if (!OFConfig.isCustomItems() || CustomItems.isUseGlint())
        {
            if (!OFConfig.isShaders() || !Shaders.isShadowPass)
            {
                ...
                if (OFConfig.isShaders() && !this.renderItemGui)
                {
