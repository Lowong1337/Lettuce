...
public class OpenGlHelper {
    ...
    public static void initializeTextures() {
        ...
        if (!vboRegions) {
            ...
            String s = "VboRegions not supported, missing: " + OFConfig.listToString(list);
            OFConfig.dbg(s);
            logText = logText + s + "\n";
        }
    ...
    public static boolean useVbo() {
        return OFConfig.isMultiTexture() ? false : (OFConfig.isRenderRegions() && !vboRegions ? false : vboSupported && Minecraft.getMinecraft().gameSettings.useVbo);
    }
    ...
    public static boolean isFramebufferEnabled() {
        return (!OFConfig.isAntialiasing() && framebufferSupported && Minecraft.getMinecraft().gameSettings.fboEnable);
    }
