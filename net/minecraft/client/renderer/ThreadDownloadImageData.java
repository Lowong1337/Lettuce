...
public class ThreadDownloadImageData extends SimpleTexture
{
    ...
    private void checkTextureUploaded()
    {
        if (!this.textureUploaded && this.bufferedImage != null)
        {
            ...
            {
                ShadersTex.loadSimpleTexture(super.getGlTextureId(), this.bufferedImage, false, false, OFConfig.getResourceManager(), this.textureLocation, this.getMultiTexID());
            }
            else
            {
                ...
                else
                {
                    try
                    {
                        ...
                        if (httpurlconnection.getResponseCode() / 100 != 2)
                        {
                            ...
                            {
                                OFConfig.readAll(httpurlconnection.getErrorStream());
                            }
