...
public class TileEntitySignRenderer extends TileEntitySpecialRenderer<TileEntitySign>
{
    ...
    private static boolean isRenderText(TileEntitySign p_isRenderText_0_)
    {
        ...
        else if (OFConfig.getMinecraft().currentScreen instanceof GuiEditSign)
        {
            return true;
        }
        else
        {
            if (!OFConfig.zoomMode && p_isRenderText_0_.lineBeingEdited < 0)
            {
                Entity entity = OFConfig.getMinecraft().getRenderViewEntity();
    ...
    {
        Minecraft minecraft = OFConfig.getMinecraft();
        double d0 = (double) OFConfig.limit(minecraft.gameSettings.fovSetting, 1.0F, 120.0F);
