...
import best.lettuce.gui.authentication.AuthMenu;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("Lecture/logo.png");
    ...
    private void startGame() throws LWJGLException {
        ...
        Lecture.INSTANCE.onStart();

        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(new AuthMenu(), this, this.serverName, this.serverPort));
            Display.setTitle(MinecraftInstance.NAME + " " + MinecraftInstance.VERSION + " | Salat spise som kuk | Sabala \u0256ua nu abe koklozi ene | \u0428\u0430\u043D\u0446\u0430\u0439\u043D\u044B \u0443\u0440\u0433\u0430\u043C\u0430\u043B \u0442\u0430\u0445\u0438\u0430 \u0448\u0438\u0433 \u0438\u0434\u043D\u044D | \u751F\u83DC\u5403\u8D77\u6765\u50CF\u516C\u9E21 | Lettuce mangan kaya jago | La lattuga mangia come un gallo | \uC591\uC0C1\uCD94\uB294 \uB2ED\uCC98\uB7FC \uBA39\uB294\uB2E4 | Alface come como galo | \u0938\u0932\u093E\u0926 \u0915\u094B \u092E\u0941\u0930\u094D\u0917\u0947 \u0915\u0940 \u0924\u0930\u0939 \u0916\u093E\u092F\u093E \u091C\u093E\u0924\u093E \u0939\u0948");
        } else {
            this.displayGuiScreen(new AuthMenu());
            Display.setTitle(MinecraftInstance.NAME + " " + MinecraftInstance.VERSION + " | Salat spise som kuk | Sabala \u0256ua nu abe koklozi ene | \u0428\u0430\u043D\u0446\u0430\u0439\u043D\u044B \u0443\u0440\u0433\u0430\u043C\u0430\u043B \u0442\u0430\u0445\u0438\u0430 \u0448\u0438\u0433 \u0438\u0434\u043D\u044D | \u751F\u83DC\u5403\u8D77\u6765\u50CF\u516C\u9E21 | Lettuce mangan kaya jago | La lattuga mangia come un gallo | \uC591\uC0C1\uCD94\uB294 \uB2ED\uCC98\uB7FC \uBA39\uB294\uB2E4 | Alface come como galo | \u0938\u0932\u093E\u0926 \u0915\u094B \u092E\u0941\u0930\u094D\u0917\u0947 \u0915\u0940 \u0924\u0930\u0939 \u0916\u093E\u092F\u093E \u091C\u093E\u0924\u093E \u0939\u0948");
        }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Loading Cracked " + MinecraftInstance.NAME + " | guys im eating sonalatino");
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) {
        ...
        GlStateManager.matrixMode(5889);
        GlStateManager.loadIdentity();
        GlStateManager.ortho(0.0D, scaledresolution.getWidth(), scaledresolution.getHeight(), 0.0D, 1000.0D, 3000.0D);
        GlStateManager.matrixMode(5888);
        GlStateManager.loadIdentity();
        ...
        worldrenderer.pos(0.0D, this.displayHeight, 0.0D).tex(0.0D, 0.0D).color(0, 0, 0, 255).endVertex();
        worldrenderer.pos(this.displayWidth, this.displayHeight, 0.0D).tex(0.0D, 0.0D).color(0, 0, 0, 255).endVertex();
        worldrenderer.pos(this.displayWidth, 0.0D, 0.0D).tex(0.0D, 0.0D).color(0, 0, 0, 255).endVertex();
        worldrenderer.pos(0.0D, 0.0D, 0.0D).tex(0.0D, 0.0D).color(0, 0, 0, 255).endVertex();
        tessellator.draw();
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        int j = 256;
        int k = 256;
        this.draw((scaledresolution.getWidth() - j) / 2, (scaledresolution.getHeight() - k) / 2, 0, 0, j, k, 255, 255, 255, 255);
        GlStateManager.disableLighting();
        GlStateManager.disableFog();
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn == null && this.theWorld == null) {
            guiScreenIn = new LettuceMainMenu();
        } else if (guiScreenIn == null && this.thePlayer.getHealth() <= 0.0F) {
            guiScreenIn = new GuiGameOver();
        }

        if (guiScreenIn instanceof LettuceMainMenu) {
    ...
    public void runTick() throws IOException {
        Lecture.INSTANCE.getEventManager().dispatch(new EventTick());
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        Lecture.INSTANCE.getEventManager().dispatch(new EventKeyPressed(k));
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            ...
            Lecture.INSTANCE.getEventManager().dispatch(new EventWorld());
        } else {
