...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("Lettuce/logo.png");
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Loading " + MinecraftInstance.NAME + "...");
    ...
    public void runTick() throws IOException {
        Lettuce.INSTANCE.getEventManager().dispatch(new EventTick());
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        Lettuce.INSTANCE.getEventManager().dispatch(new EventKeyPressed(k));
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            ...
            Lettuce.INSTANCE.getEventManager().dispatch(new EventWorld());
        } else {
