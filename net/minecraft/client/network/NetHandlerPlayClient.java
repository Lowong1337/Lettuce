...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void onDisconnect(IChatComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new LettuceMainMenu()), "disconnect.lost", reason));
        }
    }
    ...
    public void handleChat(S02PacketChat packetIn) {
        ...
        Lecture.INSTANCE.getEventManager().dispatch(e);
    ...
    public void handleTitle(S45PacketTitle packetIn) {
        ...
        switch (s45packettitle$type) {
            case TITLE: s = s2; break;
            case SUBTITLE: s1 = s2; break;
            case RESET: {
