...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
        ...
        final EventFlag event = new EventFlag(new C03PacketPlayer.C06PacketPlayerPosLook(entityplayer.posX, entityplayer.posY, entityplayer.posZ, entityplayer.rotationYaw, entityplayer.rotationPitch, false), d0, d1, d2, f, f1);
    ...
    public void onDisconnect(IChatComponent reason) {
        ...
        this.gameController.displayGuiScreen(new GuiDisconnected(Objects.requireNonNullElseGet(this.guiScreenServer, () -> new GuiMultiplayer(new LettuceMainMenu())), "disconnect.lost", reason));
    }
    ...
    public void handleChat(S02PacketChat packetIn) {
        ...
        EventChatMessage e = new EventChatMessage(packetIn.getType(), packetIn.getChatComponent());
        Lettuce.INSTANCE.getEventManager().dispatch(e);
