...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            Lettuce.INSTANCE.getEventManager().dispatch(new EventUpdate());
    ...
    public void onUpdateWalkingPlayer() {
        ...
        Lettuce.INSTANCE.getEventManager().dispatch(updatePositionEvent);
    ...
    public void sendChatMessage(String message) {
        if (Lettuce.INSTANCE.getCommandManager().execute(message) || message.startsWith(CommandManager.CHAT_PREFIX)) {
            return;
        }
    ...
    public void jump() {
        ...
        Lettuce.INSTANCE.getEventManager().dispatch(eventJump);
