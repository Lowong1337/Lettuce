...
public class GuiIngame extends Gui {
    ...
    public AbstractFontRenderer getFontRenderer() {
        Scoreboard scoreboard = Lettuce.INSTANCE.getModuleManager().getModule(Scoreboard.class);
        return switch (scoreboard.font.getMode()) {
            default -> mc.fontRendererObj;
            case "Lettuce" -> MinecraftInstance.lettuceFont20;
            case "Tahoma" -> MinecraftInstance.tahoma20;
            case "Neverlose" -> MinecraftInstance.neverlose20;
        };
    }
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        Lettuce.INSTANCE.getEventManager().dispatch(new EventPreRender());

        VisualEffects visualEffects = Lettuce.INSTANCE.getModuleManager().getModule(VisualEffects.class);
        visualEffects.blurScreen();

        Lettuce.INSTANCE.getEventManager().dispatch(new EventRender2D(scaledresolution.getWidth(), scaledresolution.getHeight(), partialTicks));
    ...
    private void renderscore(ScoreObjective objective, ScaledResolution scaledRes) {
        ...
        StreamerMode streamerMode = Lettuce.INSTANCE.getModuleManager().getModule(StreamerMode.class);
        Scoreboard sb = Lettuce.INSTANCE.getModuleManager().getModule(Scoreboard.class);
        ...
        for (Score score1 : collection) {
            ...
            if (streamerMode.isEnabled() && streamerMode.nameprotect.isEnabled()) {
                s1 = s1.replace(mc.thePlayer.getName(), streamerMode.name.getString());
                s2 = s2.replace(mc.thePlayer.getName(), streamerMode.name.getString());
            }
            ...
            switch (sb.font.getMode()) {
                case "Lettuce" -> {
                    ...
                    Lettuce.lettuceFont18.drawString(s1, l1, k + sb.yOffset.getValue().floatValue() + 0.5f, Color.WHITE);
                    //Lettuce.text(s1);
                    if (sb.redNumbers.isEnabled()) {
                        Lettuce.lettuceFont16.drawString(s2, l - Lettuce.lettuceFont16.getStringWidth(s2), k + sb.yOffset.getValue().floatValue(), s1.contains("lettuce") ? HUD.color : Color.WHITE);
                    }
                    ...
                    if (j == collection.size()) {
                        ...
                        Lettuce.lettuceFont18.drawString(s3, l1 + i / 2 - (float) this.getFontRenderer().getStringWidth(s3) / 2, k - getFontRenderer().getHeight() + sb.yOffset.getValue().floatValue(), Color.WHITE);
                    }
                }
                case "Minecraft" -> {
                ...
                case "Tahoma" -> {
                    ...
                    //this.getFontRenderer().drawString(s1, l1, k + sb.yOffset.getValue().floatValue(), 553648127);
                    Lettuce.tahoma18.drawString(s1, l1, k + sb.yOffset.getValue().floatValue() + 1f, Color.WHITE);
                    if (sb.redNumbers.isEnabled()) {
                        Lettuce.tahoma18.drawString(s2, l - Lettuce.tahoma18.getStringWidth(s2), k + sb.yOffset.getValue().floatValue() + 1f, s1.contains("lettuce") ? HUD.color : Color.WHITE);
                    }
                    ...
                    if (j == collection.size()) {
                        ...
                        drawRect(l1 - 2, k - getFontRenderer().getHeight() - 1 + sb.yOffset.getValue().floatValue(), l, k - 1 + sb.yOffset.getValue().floatValue(), new Color(0, 0, 0, 127).getRGB());
                        drawRect(l1 - 2, k - 1 + sb.yOffset.getValue().floatValue(), l, k + sb.yOffset.getValue().floatValue(), new Color(0, 0, 0, 127).getRGB());
                        Lettuce.tahoma18.drawString(s3, l1 + i / 2 - (float) this.getFontRenderer().getStringWidth(s3) / 2, k - getFontRenderer().getHeight() + sb.yOffset.getValue().floatValue() + 1f, Color.WHITE);
                    }
                }
                case "Neverlose" -> {
                    ...
                    //this.getFontRenderer().drawString(s1, l1, k + sb.yOffset.getValue().floatValue(), 553648127);
                    Lettuce.neverlose20.drawString(s1, l1, k + sb.yOffset.getValue().floatValue() + 0.5f, Color.WHITE);
                    if (sb.redNumbers.isEnabled()) {
                        Lettuce.neverlose20.drawString(s2, l - Lettuce.neverlose20.getStringWidth(s2), k + sb.yOffset.getValue().floatValue() + 1, s1.contains("lettuce") ? HUD.color : Color.WHITE);
                    }
                    ...
                    if (j == collection.size()) {
                        ...
                        drawRect(l1 - 2, k - getFontRenderer().getHeight() - 1 + sb.yOffset.getValue().floatValue(), l, k - 1 + sb.yOffset.getValue().floatValue(), new Color(0, 0, 0, 127).getRGB());
                        drawRect(l1 - 2, k - 1 + sb.yOffset.getValue().floatValue(), l, k + sb.yOffset.getValue().floatValue(), new Color(0, 0, 0, 127).getRGB());
                        Lettuce.neverlose20.drawString(s3, l1 + i / 2 - (float) this.getFontRenderer().getStringWidth(s3) / 2, k - getFontRenderer().getHeight() + sb.yOffset.getValue().floatValue() + 1, Color.WHITE);
                    }
                }
            }
        }
    ...
    public void renderScoreboardBlur(ScaledResolution scaledRes) {
        Scoreboard modScoreboard = Lettuce.INSTANCE.getModuleManager().getModule(Scoreboard.class);
