...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ChestStealer stealer = Lettuce.INSTANCE.getModuleManager().getModule(ChestStealer.class);
        if (stealer.isEnabled()) {
            if (mc.thePlayer.openContainer instanceof ContainerChest) {
                if (stealer.silent.isEnabled()) {
                    Lettuce.lettuceFont22.drawCenteredString("Stealing chest, press E or ESC to cancel.", this.width / 2f, this.height / 2f + 15, Color.WHITE.getRGB());
