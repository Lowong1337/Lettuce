...
public class GuiSlider extends GuiButton
{
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            //RoundedUtils.drawRoundOutline(xPosition, yPosition, (int)(this.sliderPosition * (float)(this.width - 8)), height, 3f, 3f, new Color(0,0,0,90), this.hovered? ColorUtils.rainbow(10, 1, 12, 4, 70) : new Color(0,0,0,90));
        }
    }
