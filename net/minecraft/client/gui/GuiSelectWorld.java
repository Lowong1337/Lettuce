...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, "§l§nTsukasa.tokyo", this.width / 2, 10, Color.YELLOW.getRGB());
        this.drawCenteredString(this.fontRendererObj, "§l§nTsukasa.tokyo", this.width / 2, 1, Color.YELLOW.getRGB());
