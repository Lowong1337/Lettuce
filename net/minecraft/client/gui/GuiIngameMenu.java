...
public class GuiIngameMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        int i = -16;
        int j = 98;
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 96 + i, I18n.format("menu.returnToMenu")));
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 72 + i, 98, 20, I18n.format("menu.options")));
        GuiButton guibutton;
        this.buttonList.add(guibutton = new GuiButton(7, this.width / 2 + 2, this.height / 4 + 72 + i, 98, 20, I18n.format("menu.shareToLan")));
