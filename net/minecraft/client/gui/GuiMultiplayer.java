...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(4, this.width / 2 - 50, this.height - 52, 100, 20, I18n.format("")));
        this.buttonList.add(new GuiButton(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, I18n.format("")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.RED + "§l§nTsukasa.tokyo", this.width / 2, 9, 16777215);
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.RED + "§l§nTsukasa.tokyo", this.width / 2, 0, 16777215);
        ...
        lettuceBoldFont20.drawString(EnumChatFormatting.RED + "Tsukasa.tokyo", this.width - 93.5f, lettuceBoldFont20.getMiddleOfBox(20) + 18, Color.WHITE);
    ...
    if(hoveraddalt && mouseButton == 0){
        if(!textbox.isEmpty()) {
            AltManagerUtils.getInstance().loginWithString("tsukasa" + textbox.getText(), "", false);
            NotificationManager.post(new Notification(NotificationType.SUCCESS, "", "Successfully logged as " + textbox.getText(), 3));
            textbox.setText("");
        }
        else {
