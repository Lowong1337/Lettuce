...
import best.lettuce.gui.mainmenu.utils.MainMenuBackground;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
    private MainMenuBackground shaderBackground;
    private MainMenuBackground shittyshaderBackground;
    ...
    public GuiScreen() {
        try {
            this.shaderBackground = new MainMenuBackground("/assets/minecraft/Lecture/Shaders/mainmenu.fsh");
            this.shittyshaderBackground = new MainMenuBackground("/assets/minecraft/Lecture/Shaders/nigga.fsh");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void renderBackground() {
        ...
        this.shaderBackground.useShader(this.width * 2, this.height * 2, (System.currentTimeMillis() - initTime) / 1000f);
    ...
    public void renderAuthShittyBackGround() {
        GlStateManager.disableCull();
        this.shittyshaderBackground.useShader(this.width * 2, this.height * 2, (System.currentTimeMillis() - initTime) / 1000f);
