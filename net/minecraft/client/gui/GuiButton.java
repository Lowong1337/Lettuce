...
public class GuiButton extends Gui
{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            MinecraftInstance.lettuceFont20.drawCenteredStringWithShadow(this.displayString, this.xPosition + (float) this.width / 2, this.yPosition + (float) (this.height - 8) / 2, ColorUtils.interpolateColor(Color.WHITE.darker(), new Color(210, 210, 32, 255), animation.getOutput().floatValue()));
        }
    }
