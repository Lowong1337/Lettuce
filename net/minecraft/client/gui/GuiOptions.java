...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
         ...
         */
        this.buttonList.add(new GuiButton(4, this.width / 2 + 5, this.height / 6 + 72 - 6, 150, 20, ""));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20, ""));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 5, this.height / 6 - 12, 150, 20, ""));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            if (button.id == 4) {
                try {
                    java.awt.Desktop.getDesktop().browse(new URI("https://tsukasa.tokyo/"));
