...
public class GuiOptionSlider extends GuiButton
{
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            RoundedUtils.drawRoundOutline(xPosition + (int)(sliderValue * (float)(this.width - 8)), yPosition, 9, height, 3f, 0.1f, new Color(0,0,0,90), this.hovered? ColorUtils.rainbow(1, 12, 1, 4, 1) : new Color(0,0,0,90));
        }
    }
