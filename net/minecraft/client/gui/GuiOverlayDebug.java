...
public class GuiOverlayDebug extends Gui {
    ...
    protected List<String> call() {
        ...
        TextureMap texturemap = OFConfig.getTextureMap();
    ...
    protected List<String> getDebugInfoRight() {
        ...
        if (Reflector.FMLCommonHandler_getBrandings.exists()) {
            ...
            list.add("");
            list.addAll((Collection) Objects.requireNonNull(Reflector.call(object, Reflector.FMLCommonHandler_getBrandings, new Object[]{Boolean.FALSE})));
        }
