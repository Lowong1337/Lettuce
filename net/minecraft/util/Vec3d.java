...
public class Vec3d {
    ...
    public Vec3d normalize() {
        ...
        return var1 < 1.0E-4D ? new Vec3d(0.0D, 0.0D, 0.0D) : new Vec3d(this.xCoord / var1, this.yCoord / var1, this.zCoord / var1);
    }
    ...
    public Vec3d getIntermediateWithXValue(Vec3d vec, double x) {
        ...
        if (var4 * var4 < 1.000000011686097E-7D) {
            return null;
        } else {
    ...
    public Vec3d getIntermediateWithYValue(Vec3d vec, double y) {
        ...
        double var6 = vec.yCoord - this.yCoord;
        double var8 = vec.zCoord - this.zCoord;
        if (var6 * var6 < 1.000000011686097E-7D) {
            return null;
        } else {
    ...
    public Vec3d getIntermediateWithZValue(Vec3d vec, double z) {
        ...
        double var6 = vec.yCoord - this.yCoord;
        double var8 = vec.zCoord - this.zCoord;
        if (var8 * var8 < 1.000000011686097E-7D) {
            return null;
        } else {
