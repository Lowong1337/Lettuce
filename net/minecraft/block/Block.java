...
public class Block
{
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity)
    {
        ...
        EventCollide ec = new EventCollide(collidingEntity, pos.getX(), pos.getY(), pos.getZ(), axisalignedbb, this);
        Lecture.INSTANCE.getEventManager().dispatch(ec);
        if (ec.isCancelled()) return;

        axisalignedbb = ec.getAxisAlignedBB();
