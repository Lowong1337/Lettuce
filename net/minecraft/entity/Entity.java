...
import best.lettuce.event.impl.player.EventSafeWalk;
...
public abstract class Entity implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            double d4 = y;
            double d5 = z;
            EventSafeWalk event = new EventSafeWalk();
            if (this instanceof EntityPlayerSP) Lettuce.INSTANCE.getEventManager().dispatch(event);
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z) {
                    ...
                    Lettuce.INSTANCE.getEventManager().dispatch(new EventStep());
                }
            }
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        EventMoveUpdate playerMovementEvent = new EventMoveUpdate(strafe, forward, friction, this.rotationYaw, this.rotationPitch);
        if (this instanceof EntityPlayerSP) {
            Lettuce.INSTANCE.getEventManager().dispatch(playerMovementEvent);
        }
