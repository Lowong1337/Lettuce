...
public abstract class Container {
    ...
    public static void computeStackSize(Set<Slot> p_94525_0_, int p_94525_1_, ItemStack p_94525_2_, int p_94525_3_) {
        switch (p_94525_1_) {
            case 0 -> p_94525_2_.stackSize = MathHelper.floor_float((float) p_94525_2_.stackSize / (float) p_94525_0_.size());
            case 1 -> p_94525_2_.stackSize = 1;
            case 2 -> p_94525_2_.stackSize = p_94525_2_.getItem().getItemStackLimit();
        }
