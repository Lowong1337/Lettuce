...
public class PlayerItemParser
{
    ...
    public static PlayerItemModel parseItemModel(JsonObject obj)
    {
        ...
        if (!OFConfig.equals(s, "PlayerItem"))
        {
        ...
        else
        {
            ...
            for (int i = 0; i < jsonarray.size(); ++i)
            {
                ...
                if (s1 != null)
                {
                    ...
                    if (jsonobject1 == null)
                    {
                        OFConfig.warn("BaseID not found: " + s1);
                        continue;
                    }
                ...
                if (s2 != null)
                {
                    ...
                    {
                        OFConfig.warn("Duplicate model ID: " + s2);
                    }
                }
    ...
    private static int parseAttachModel(String attachModelStr)
    {
        ...
        {
            OFConfig.warn("Unknown attachModel: " + attachModelStr);
            return 0;
        }
    }
    ...
    public static PlayerItemRenderer parseItemRenderer(JsonObject elem, Dimension textureDim)
    {
        ...
        if (!OFConfig.equals(s, "ModelBox"))
        {
            OFConfig.warn("Unknown model type: " + s);
            return null;
        }
        else
        {
        ...
        if (jsonarray2 != null)
        {
            for (int l = 0; l < jsonarray2.size(); ++l)
            {
                ...
                if (modelrenderer3.getId() != null)
                {
                    ...
                    {
                        OFConfig.warn("Duplicate model ID: " + modelrenderer3.getId());
                    }
                }
