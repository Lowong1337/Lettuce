...
public class VboRegion
{
    ...
    {
        this.bufferIndexVertex = OFConfig.createDirectIntBuffer(this.capacity);
        this.bufferCountVertex = OFConfig.createDirectIntBuffer(this.capacity);
        this.drawMode = 7;
    ...
    private void copyVboData(int posFrom, int posTo, int size)
    {
        ...
        OFConfig.checkGlError("Copy VBO range");
    ...
    private void expandVbo(int sizeMin)
    {
        ...
        OFConfig.checkGlError("Expand VBO");
        ...
        OFConfig.checkGlError("Copy VBO: " + k);
        OpenGlHelper.glBindBuffer(OpenGlHelper.GL_COPY_READ_BUFFER, 0);
        OpenGlHelper.glBindBuffer(OpenGlHelper.GL_COPY_WRITE_BUFFER, 0);
        OpenGlHelper.glDeleteBuffers(this.glBufferId);
        this.bufferIndexVertex = OFConfig.createDirectIntBuffer(i);
        this.bufferCountVertex = OFConfig.createDirectIntBuffer(i);
        this.glBufferId = l;
        this.capacity = i;
    }
