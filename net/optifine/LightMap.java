        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    f = OFConfig.limitTo1(f);
                    float f1 = f * (float)(j - 1);
                    float f2 = OFConfig.limitTo1(torchFlickerX + 0.5F) * (float)(j - 1);
                    float f3 = OFConfig.limitTo1(OFConfig.getGameSettings().gammaSetting);
                    ...
                    for (int l = 0; l < 16; ++l)
                    {
                        for (int i1 = 0; i1 < 16; ++i1)
                        {
                            ...
                            {
                                float f4 = OFConfig.limitTo1(this.sunRgbs[l][j1] + this.torchRgbs[i1][j1]);
