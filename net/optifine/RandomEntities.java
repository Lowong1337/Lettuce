...
public class RandomEntities
{
    ...
    private static RandomEntityProperties parseProperties(ResourceLocation propLoc, ResourceLocation resLoc)
    {
        try
        {
            ...
            InputStream inputstream = OFConfig.getResourceStream(propLoc);
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    return OFConfig.hasResource(resourcelocation2) ? resourcelocation2 : null;
                }
            }
        }
    }
    ...
    {
        renderGlobal = OFConfig.getRenderGlobal();
    ...
    {
        OFConfig.dbg("RandomEntities: " + str);
    }

    public static void warn(String str)
    {
        OFConfig.warn("RandomEntities: " + str);
    }
}
