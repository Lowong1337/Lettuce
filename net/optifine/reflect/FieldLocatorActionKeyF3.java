...
public class FieldLocatorActionKeyF3 implements IFieldLocator
{
    public Field getField()
    {
        ...
        if (field == null)
        {
            OFConfig.log("(Reflector) Field not present: " + oclass.getName() + ".actionKeyF3 (field renderChunksMany not found)");
            return null;
        }
        else
        {
            ...
            if (field1 == null)
            {
                OFConfig.log("(Reflector) Field not present: " + oclass.getName() + ".actionKeyF3");
                return null;
            }
            else
            {
