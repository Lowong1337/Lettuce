...
public class ResUtils
{
    ...
    public static String[] collectFiles(IResourcePack rp, String[] prefixes, String[] suffixes, String[] defaultPaths)
    {
        ...
        {
            OFConfig.warn("Unknown resource pack type: " + rp);
            return new String[0];
        }
        else
        {
            ...
            {
                OFConfig.warn("Unknown resource pack file: " + file1);
                return new String[0];
            }
        }
    }
    ...
    public static Properties readProperties(String path, String module)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                inputstream.close();
                OFConfig.dbg("" + module + ": Loading " + path);
                return properties;
            }
        }
        ...
        {
            OFConfig.warn("" + module + ": Error reading " + path);
            return null;
        }
    }
