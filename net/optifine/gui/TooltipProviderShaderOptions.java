...
public class TooltipProviderShaderOptions extends TooltipProviderOptions
{
    ...
    private String[] makeTooltipLines(ShaderOption so, int width)
    {
        ...
        String s1 = OFConfig.normalize(so.getDescriptionText()).trim();
        ...
        {
            s3 = "\u00a78" + Lang.get("of.general.from") + ": " + OFConfig.arrayToString((Object[])so.getPaths());
        }
    ...
    {
        FontRenderer fontrenderer = OFConfig.getMinecraft().fontRendererObj;
        List<String> list = new ArrayList();
