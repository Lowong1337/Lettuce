...
public class GuiScreenCapeOF extends GuiScreenOF
{
    ...
    {
        this.fontRenderer = OFConfig.getMinecraft().fontRendererObj;
        ...
        if (button.enabled)
        {
            ...
            if (button.id == 210)
            {
                try
                {
                    ...
                    boolean flag = OFConfig.openWebLink(new URI(s4));
                ...
                {
                    OFConfig.showGuiMessage(I18n.format("of.message.capeOF.error1", new Object[0]), I18n.format("of.message.capeOF.error2", new Object[] {invalidcredentialsexception.getMessage()}));
                    OFConfig.warn("Mojang authentication failed");
                    OFConfig.warn(invalidcredentialsexception.getClass().getName() + ": " + invalidcredentialsexception.getMessage());
                }
                catch (Exception exception)
                {
                    OFConfig.warn("Error opening OptiFine cape link");
