...
public class ModelVariableUpdater
{
    ...
    public boolean initialize(IModelResolver mr)
    {
        ...
        {
            OFConfig.warn("Model variable not found: " + this.modelVariableName);
            return false;
        }
        else
        {
            ...
            {
                OFConfig.warn("Error parsing expression: " + this.expressionText);
                OFConfig.warn(parseexception.getClass().getName() + ": " + parseexception.getMessage());
                return false;
            }
        }
    }
