...
public class CustomEntityModels
{
    ...
    public static void update()
    {
        ...
        if (map == null)
        {
            OFConfig.warn("Entity render map not found, custom entity models are DISABLED.");
        }
        else if (map1 == null)
        {
            OFConfig.warn("Tile entity render map not found, custom entity models are DISABLED.");
        }
        else
        {
            active = false;
            ...
            if (OFConfig.isCustomEntityModels())
            {
                ...
                for (int i = 0; i < aresourcelocation.length; ++i)
                {
                    ...
                    OFConfig.dbg("CustomEntityModel: " + resourcelocation.getResourcePath());
                    ...
                    if (ientityrenderer != null)
                    {
                        ...
                        if (oclass != null)
                        {
                            ...
                            {
                                OFConfig.warn("Unknown renderer type: " + ientityrenderer.getClass().getName());
                            }
    ...
    private static IEntityRenderer parseEntityRender(ResourceLocation location)
    {
        ...
        {
            OFConfig.error("" + ioexception.getClass().getName() + ": " + ioexception.getMessage());
            return null;
        }
        catch (JsonParseException jsonparseexception)
        {
            OFConfig.error("" + jsonparseexception.getClass().getName() + ": " + jsonparseexception.getMessage());
            return null;
        }
    ...
    private static boolean modifyModel(ModelAdapter modelAdapter, ModelBase model, CustomModelRenderer customModelRenderer, ModelResolver modelResolver)
    {
        ...
        {
            OFConfig.warn("Model part not found: " + s + ", model: " + model);
            return false;
        }
        else
        {
