...
public abstract class ShaderOption
{
    ...
    {
        String s = OFConfig.normalize(this.description);
    ...
    public void addPaths(String[] newPaths)
    {
        ...
        for (int i = 0; i < newPaths.length; ++i)
        {
            ...
            if (!list.contains(s))
            {
                this.paths = (String[])((String[]) OFConfig.addObjectToArray(this.paths, s));
            }
        }
    }
    ...
    {
        return !OFConfig.equals(this.value, this.valueDefault);
    }
    ...
    {
        return "" + this.name + ", value: " + this.value + ", valueDefault: " + this.valueDefault + ", paths: " + OFConfig.arrayToString((Object[])this.paths);
    }
}
