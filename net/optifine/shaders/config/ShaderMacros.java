...
public class ShaderMacros
{
    ...
    {
        String s = OFConfig.openGlVendor;
    ...
    {
        String s = OFConfig.openGlRenderer;
    ...
    public static ShaderMacro[] getExtensions()
    {
        ...
        {
            String[] astring = OFConfig.getOpenGlExtensions();
    ...
    public static String getFixedMacroLines()
    {
        ...
        addMacroLine(stringbuilder, "MC_VERSION", OFConfig.getMinecraftVersionInt());
        addMacroLine(stringbuilder, "MC_GL_VERSION " + OFConfig.getGlVersion().toInt());
        addMacroLine(stringbuilder, "MC_GLSL_VERSION " + OFConfig.getGlslVersion().toInt());
