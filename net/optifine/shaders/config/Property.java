...
public class Property
{
    ...
    public void nextValue(boolean forward)
    {
        ...
        this.value = OFConfig.limit(this.value, i, j);
    ...
    {
        return "" + this.propertyName + "=" + this.getPropertyValue() + " [" + OFConfig.arrayToString((Object[])this.propertyValues) + "], value: " + this.value;
    }
}
