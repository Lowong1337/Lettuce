...
public class BlockModelUtils
{
    ...
    {
        TextureAtlasSprite textureatlassprite = OFConfig.getMinecraft().getTextureMapBlocks().getAtlasSprite(spriteName);
    ...
    {
        TextureMap texturemap = OFConfig.getMinecraft().getTextureMapBlocks();
