...
public class ModelUtils
{
    public static void dbgModel(IBakedModel model)
    {
        if (model != null)
        {
            OFConfig.dbg("Model: " + model + ", ao: " + model.isAmbientOcclusion() + ", gui3d: " + model.isGui3d() + ", builtIn: " + model.isBuiltInRenderer() + ", particle: " + model.getParticleTexture());
    ...
    {
        OFConfig.dbg(prefix + "Quad: " + quad.getClass().getName() + ", type: " + name + ", face: " + quad.getFace() + ", tint: " + quad.getTintIndex() + ", sprite: " + quad.getSprite());
    ...
    {
        int i = vd.length / 4;
        OFConfig.dbg(prefix + "Length: " + vd.length + ", step: " + i);
        ...
        for (int j = 0; j < 4; ++j)
        {
            ...
            OFConfig.dbg(prefix + j + " xyz: " + f + "," + f1 + "," + f2 + " col: " + l + " u,v: " + f3 + "," + f4);
        }
    }
