...
{
    private static Minecraft mc = OFConfig.getMinecraft();
    ...
    private static void update(IResourcePack rp, List<List<CustomGuiProperties>> listProps)
    {
        ...
        for (int i = 0; i < astring.length; ++i)
        {
            ...
            try
            {
                ...
                if (inputstream == null)
                {
                    OFConfig.warn("CustomGuis file not found: " + s);
                }
                else
                {
